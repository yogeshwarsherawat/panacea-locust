...
class LogsInfoAPI(BaseAPI):
    class PayloadTypes:
        """Payload type constants for LogsInfoAPI"""
    ...
    def __init__(self):
        ...
        self.endpoint = "api/v1/insights/logs/info"
    ...
    def generate_payload(self, payload_type: str = None):
        if payload_type is None:
            ...
            payload_types = [
                LogsInfoAPI.PayloadTypes.COMBO_ID_ONLY,
                LogsInfoAPI.PayloadTypes.BUNDLE_ID_ONLY,
            ]
    ...
    def get_payload(self, payload_type: str):
        match payload_type:
            case LogsInfoAPI.PayloadTypes.COMBO_ID_ONLY:
                return {
                    "combo_id": self.combo_id
                }
            case LogsInfoAPI.PayloadTypes.BUNDLE_ID_ONLY:
                return {
