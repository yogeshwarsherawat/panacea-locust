...
class ListCombosAPI(BaseAPI):
    class PayloadTypes:
        """Payload type constants for ListCombosAPI"""
        DEFAULT = "default"
        PAGE_2 = "page_2"
    ...
    def generate_payload(self, payload_type: str = None):
        if payload_type is None:
            ...
            payload_types = [
                ListCombosAPI.PayloadTypes.DEFAULT,
                ListCombosAPI.PayloadTypes.PAGE_2,
                ListCombosAPI.PayloadTypes.CASE_OWNER_EMAIL,
                ListCombosAPI.PayloadTypes.SFDC_CASE_NUMBER,
                ListCombosAPI.PayloadTypes.CASE_OWNER_EMAIL_AND_SFDC_CASE_NUMBER,
            ]
    ...
    def get_payload(self, payload_type: str):
        match payload_type:
            case ListCombosAPI.PayloadTypes.DEFAULT:
                return {
                    "page_size": 20,
                    "page_no": 1
                }
            case ListCombosAPI.PayloadTypes.PAGE_2:
                return {
                    "page_size": 20,
                    "page_no": 2
                }
            case ListCombosAPI.PayloadTypes.CASE_OWNER_EMAIL:
            ...
            case ListCombosAPI.PayloadTypes.SFDC_CASE_NUMBER:
            ...
            case ListCombosAPI.PayloadTypes.CASE_OWNER_EMAIL_AND_SFDC_CASE_NUMBER:
                case_owner_email = random.choice(json_payload.get_case_owner_emails())
                sfdc_case_number = random.choice(json_payload.get_sfdc_case_numbers())
                return {
                    "page_size": 20,
